...
from src import silence_asyncio_run_error
...
async def parse_city_merchant(city: dict):
    ...
    url, params = await get_url_and_params(
    ...
    while True:
        response, status_code = await fetch(url, params)
